...
# The variables are the name, sex, and popularity of the name of the individuals within the database, and the case is the year in which the individual was born
...
The variables in the graph that are similar to the variables in the raw data table include name, year, and popularity
...
Yes cases have been grouped and summarized by indiviual names as well as the most popular name for a paticular case, meaning a given year.
